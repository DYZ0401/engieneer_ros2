...
def generate_launch_description():
    package_name = 'engineer_moveit_config'

    robot_name_in_model = 'engineer_description'

    pkg_share = FindPackageShare(package=package_name).find(package_name) 
    urdf_model_path = os.path.join(pkg_share, f'config/gazebo_engineer_description.urdf.xacro')
